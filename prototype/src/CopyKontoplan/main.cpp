...
int main( int argc, char* argv[] )
{
  ...
  frmCopyKtoplan* mywidget = new frmCopyKtoplan();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - CPYKTOW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n CPYKTOW kommer inte att fungera!\n");
