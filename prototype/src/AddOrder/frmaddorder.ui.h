...
void frmAddOrder::lineOrderLeveranstid_returnPressed()
{
   ...
   int dag;
    ...
    orderleveranstid=lineOrderLeveranstid->text();	/* ÅÅÅÅ-MM-DD*/
        /****  Beräkning av leveransvecka , Start ****/
    int tmp1=orderleveranstid.mid(0,4).toInt();		/* Årtal, ÅÅÅÅ*/
    int tmp2=orderleveranstid.mid(5,2).toInt();		/* Månad, MM */
