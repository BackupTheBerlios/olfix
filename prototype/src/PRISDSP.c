/***************************************************************************
                          PRISDSP.c  -  description
                             -------------------
			     Visa data om en produktgrupp/produktklass
    Version		 : 0.2
    begin                : Fre  3 febr	2006
...
/*
	...
	Kommando: ./PRISDSP artikelnr

	Function: Visa priser/prislistor för en artikel

	OUTPUT:	6 st fält,
		ARTIKELNR, PRIS1, PRIS2, PRIS3, PRIS4, PRIS5
		samt errornb och error (text)

***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/PRISDSP.c,v 1.1 2007/02/18 10:51:42 janpihlgren Exp $ " ;
...
/* ================================================================================ */
  ...
  if (argc <ANTARG - 1){
  	fprintf(stderr,"Error: Pris för artikelnr saknas.\n");
	exit(-1);
  }
/*
  int i;
...
*/
  char temp1a[]="SELECT * FROM PRISLISTA WHERE (ARTIKELNR = \"";
  char temp2[]="\"";
  char temp4[]=")";
  char temp5[200]="";
  char artikelnr[31]="";
...
/*
    fprintf(stderr,"PRISDSP Artikelnr = %s\n",artikelnr);
*/
  strncpy(temp5,temp1a,strlen(temp1a));
/* SELECT * FROM PRISLISTA WHERE (ARTIKELNR = "	*/
  strncat(temp5,artikelnr,strlen(artikelnr));/* 12334 */
/* SELECT * FROM PRISLISTA WHERE (ARTIKELNR = "12334	*/
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
/* SELECT * FROM PRISLISTA WHERE (ARTIKELNR = "12334"	*/
  strncat(temp5,temp4,strlen(temp4)); /*  )     */
/* SELECT * FROM PRISLISTA WHERE (ARTIKELNR = "12334")	*/
/*  fprintf(stderr,"PRISDSP temp5 = %s\n",temp5);	*/

  mysql_init(&my_connection);
  if (mysql_real_connect(&my_connection, "localhost",  "olfix", "olfix", databas, 0, NULL, 0)){
/*  	fprintf(stdout,"PRISDSP_Connection success\n");	*/
  	res = mysql_query(&my_connection,temp5);
  	if (res){
/*  		fprintf(stderr,"PRISDSP ERROR\n");	*/
		fprintf(stderr,"Error: PRISDSP SELECT errno: %d\n",mysql_errno(&my_connection));
        }
	else{
...
/*		if (res_ptr){	*/
		...
		fprintf(stderr,"Error: PRISDSP Retriev error:  %s\n", mysql_error(&my_connection));
		}
	}
