...
int main( int argc, char* argv[] )
{
  ...
  frmOffertTillOrder* mywidget = new frmOffertTillOrder();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - OFF2ORDW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n OFF2ORDW kommer inte att fungera!\n");
