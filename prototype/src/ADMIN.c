 ...
 *********************************************** ****************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/ADMIN.c,v 1.4 2007/02/12 04:43:17 janpihlgren Exp $ " ;
...
char userid[21];			/* Utökad från 9 till 21 2007-02-12 */
...
/************************************************************************/
	...
	dummy = fgets(rad,sizeof(rad),stdin);
