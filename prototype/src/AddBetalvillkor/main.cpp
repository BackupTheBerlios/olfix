...
int main( int argc, char* argv[] )
{
  ...
  frmAddBetalvillkor* mywidget = new frmAddBetalvillkor();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - ADDBETVW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n ADDBETVW kommer inte att fungera!\n");
