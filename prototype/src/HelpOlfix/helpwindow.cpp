/****************************************************************************
** $Id: helpwindow.cpp,v 1.1 2004/02/20 08:00:07 janpihlgren Exp $
**
...
//    qDebug("Current Path=%s",binpath.latin1());
...
//    qDebug("temppath=%s",temppath.latin1());

    QString helpfilepath;
//    helpfilepath=binpath+home_;
    helpfilepath=temppath+home_;
//    qDebug("helpfilepath=%s",helpfilepath.latin1());
...
//      setCaption( "OLFIX - Helpviewer - " + url );
//    else
//        setCaption( "OLFIX - Helpviewer - " + browser->documentTitle() ) ;
