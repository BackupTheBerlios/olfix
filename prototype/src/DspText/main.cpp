...
int main( int argc, char* argv[] )
{
  ...
  frmDspText* mywidget = new frmDspText();
  mywidget->linEditTextNr->setText(QString(argv[1])+"\n");
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - DSPLEVW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n DSPTXTW kommer inte att fungera!\n");
