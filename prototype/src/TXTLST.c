/***************************************************************************
                          TXTLST.c  -  description
			  Lista bokföringsår
                             -------------------
    Version		 : 0.2
    begin                : Ons 22 nov  2005
...
/*
	...
	Function: Lista texterna i TEXTREG
...
***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/TXTLST.c,v 1.2 2007/02/19 06:01:14 janpihlgren Exp $ " ;
...
int main(int argc, char *argv[], char *envp[])
{
  ...
  char temp1[]="SELECT * FROM TEXTREG ORDER BY TEXTNR";
  char temp5[200]="";

/* fprintf(stderr,"TXTLST argc = %d\n",argc);			*/
/*  for (i=0;i< argc;i++){
  	fprintf(stderr,"TXTLST argv%d = %s\n",i,argv[i]);
    }
*/
/* ================================================================================ */
...
/*  fprintf(stderr,"TXTLST temp5=%s\n",temp5);		*/
  mysql_init(&my_connection);
  if (mysql_real_connect(&my_connection, "localhost",  "olfix", "olfix", databas, 0, NULL, 0)){
/*  	fprintf(stdout,"TXTLST_Connection success\n");	*/
  	res = mysql_query(&my_connection,temp5);
/*  	fprintf(stderr,"TXTLST hit res=%d\n",res);	*/
  	if (res){
		fprintf(stderr,"Error: TXTLST SELECT errno: %d\n",mysql_errno(&my_connection));
        }else{
		res_ptr=mysql_store_result(&my_connection);
		if (res_ptr){
			i=1;
/*			fprintf(stdout,"TXTLST:Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr));	*/
			fprintf(stdout,"OK: NR_%lu_:",(unsigned long)mysql_num_rows(res_ptr));
			while ((sqlrow=mysql_fetch_row(res_ptr)))  {
/*				fprintf(stderr,"TXTLST:Fetched data....}");	*/
				display_row();
				i++;
			}
			fprintf(stdout,"END\n");
