...
/*
	...
	Kommando: ./VERHLST arid

	Function: Visa lägsta datum och högsta datum i tabell VERHUVUD för angivet arid
...
***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/VERHLST.c,v 1.2 2007/02/19 07:03:19 janpihlgren Exp $ " ;
...
int main(int argc, char *argv[], char *envp[])
{
  ...
  char temp1[]="SELECT * FROM VERHUVUD WHERE ARID = \"";
  char temp2[]="\"";
  char temp5[200]="";

/*  for (i=0;i< argc;i++){
  	fprintf(stderr,"VERHLST argv%d = %s\n",i,argv[i]);
  }
*/
...
/*  	fprintf(stdout,"VERHLST_Connection success\n");	*/
  	res = mysql_query(&my_connection,temp5);
/*  	fprintf(stderr,"VERHLST hit res=%d\n",res);	*/
  	if (res){
/*  		fprintf(stderr,"VERHLST ERROR\n");	*/
		fprintf(stderr,"Error: VERHLST SELECT errno: %d\n",mysql_errno(&my_connection));
        }
	else{
...
/*				fprintf(stdout,"\n");				*/
			...
			fprintf(stderr,"Error: VERHLST Data saknas:  %s\n", mysql_error(&my_connection));
		}
			if (mysql_errno(&my_connection))  {
				fprintf(stderr,"Error: VERHLST Retriev error:  %s\n", mysql_error(&my_connection));
			}
		}
	mysql_free_result(res_ptr);
    	...
    	fprintf(stderr,"Error: VERHLST Connection failed\n");
    	if (mysql_errno(&my_connection))   {
    		fprintf(stderr,"Error: VERHLST Connection error %d:  %s\n",
