...
#define MAXSTRING 5000
    ...
    QString fromvernr;
    QString tomdatum;
    QString tmpdatum;		/* Används i funktionen frmSaldolista::CheckDatum(fromdatum )*/
    QString tomdate;
    QString tomvernr;
    QString period;
    QString ftgnamn;
...
//	lineEditFromDatum->setText(fromdatum);
    ...
    frmSaldolista::CheckDatum(fromdatum ); 		// Kontrollera datumformat ÅÅÅÅ-MM-DD
    fromdatum=tmpdatum;
    lineEditFromDatum->setText(fromdatum);
...
//	lineEditTomDatum->setText(tomdatum);
    ...
    frmSaldolista::CheckDatum(tomdatum );  		// Kontrollera datumformat ÅÅÅÅ-MM-DD  
    tomdatum=tmpdatum;
    lineEditTomDatum->setText(tomdatum);
