...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/KUCHG.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/*	fprintf(stderr,"temp5 = %s\n",temp5);				*/
  ...
  strncat(temp5,kundnr,strlen(kundnr));
  strncat(temp5,temp2,strlen(temp2));
/*  fprintf(stderr,"\nKUCHG: temp5 = %s\n",temp5);	*/
/*  exit(0);						*/
