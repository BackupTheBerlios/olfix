...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/VALADD.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/* INSERT INTO VALUTA(VALUTAID,LAND,SALJ,KOP,BETECKNING) VALUES ("SEK  */
  ...
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
/* INSERT INTO VALUTA(VALUTAID,LAND,SALJ,KOP,BETECKNING) VALUES ("SEK","  */
  strncat(temp5,land,strlen(land));/* Sverige  */
...
/* INSERT INTO VALUTA(VALUTAID,LAND,SALJ,KOP,BETECKNING) VALUES ("SEK","Sverige","1.22","1.23  */
  ...
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
/* INSERT INTO VALUTA(VALUTAID,LAND,SALJ,KOP,BETECKNING) VALUES ("SEK","Sverige","1.22","1.23"," */
  strncat(temp5,beteckning,strlen(beteckning));
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
