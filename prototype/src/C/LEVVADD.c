...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/LEVVADD.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/* ================================================================================ */
  ...
  strncpy(levvillkor,argv[1],strlen(argv[1]));
