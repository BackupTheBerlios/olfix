...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/HBOKRPT.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
int main(int argc, char *argv[], char *envp[])
{
  ...
  char temp1g[]=" ORDER BY KTONR,VERNR";
  char temp2[]="\"";
  char temp5[400]="";
  char arid[3]="";
  char fromdatum[11]="";
...
/*  fprintf(stderr,"HBOKRPT:Connection success\n");	*/
  ...
  if (res){
	...
	if (res_ptr){
		i=1;
/*		fprintf(stderr,"HBOKRPT:Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr));	*/
		fprintf(stdout,"NR_%lu_:",(unsigned long)mysql_num_rows(res_ptr));
		while ((sqlrow=mysql_fetch_row(res_ptr)))  {
/*		fprintf(stderr,"HBOKRPT:Fetched data....}");	*/
/*			fprintf(stdout,"%d ",i);		*/
			display_row();
			i++;
		}
