...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/BARCHK.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
//  fprintf(stdout,"BARCHKmain:Connection success\n");
  	...
  	if (res){
		fprintf(stderr,"Error: BARCHK SELECT error: %s\n",mysql_error(&my_connection));
  	}
  	else{
		res_ptr=mysql_store_result(&my_connection);
		if (res_ptr){
//			fprintf(stderr,"BARCHK Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr));
