...
/*
	INPUT: 2 st arg. LEVSETTNR, LEVSETTTEXT (fälten i tabellen LEVSETT)

	Kommando: ./LEVSADD 001 "ASG.Kundnr 999999"

	Function: Add record i tabell LEVSETT

	OUTPUT: errornb och error (text)

*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/LEVSADD.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/* int i;	*/
  ...
  char temp1[]="INSERT INTO LEVSETT(LEVSETTNR,LEVSETTTEXT) VALUES (\"";
  char temp2[]="\"";
  char temp3[]=",";
  char temp4[]=")";
  char temp5[200]="";
...
/*  fprintf(stderr,"argc=%d\n",argc);	*/
  if (argc < ANTARG){
  	fprintf(stderr,"Error: LEVSADD. Data saknas!\n");
	exit(0);
  }
/* ================================================================================ */
...
/* INSERT INTO LEVSETT(LEVSETTNR,LEVSETTTEXT) VALUES ("  */
  strncat(temp5,levsett,strlen(levsett));/* 001 */
/* INSERT INTO LEVSETT(LEVSETTNR,LEVSETTTEXT) VALUES ( "001 */
...
/* fprintf(stdout,"USERADD:Connection success\n");		*/
	...
	fprintf(stderr,"Error: LEVSADD INSERT error: %d  %s\n", mysql_errno(&my_connection),
