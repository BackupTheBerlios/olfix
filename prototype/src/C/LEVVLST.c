...
/*
	...
	Function: Lista leveransvillkor ur tabellen LEVVILLKOR, VILLKORSNR,VILLKORSTEXT

	OUTPUT: VILLKORSNR VILLKORSTEXT
	samt errornb och error (text)

***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/LEVVLST.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/* fprintf(stderr,"LEVVLST argc = %d\n",argc);			*/
/*  for (i=0;i< argc;i++){
  	fprintf(stderr,"LEVVLST argv%d = %s\n",i,argv[i]);
    }
*/
/* ================================================================================ */
...
/*  	fprintf(stdout,"LEVVLST_Connection success\n");	*/
  	res = mysql_query(&my_connection,temp5);
/*  	fprintf(stderr,"LEVVLST hit res=%d\n",res);	*/
  	if (res){
/*  		fprintf(stderr,"LEVVLST ERROR\n");	*/
		fprintf(stderr,"Error: LEVVLST SELECT errno: %d\n",mysql_errno(&my_connection));
        }else{
		res_ptr=mysql_store_result(&my_connection);
		if (res_ptr){
			i=1;
/*			fprintf(stdout,"LEVVLST:Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr));	*/
			fprintf(stdout,"OK: NR_%lu_:",(unsigned long)mysql_num_rows(res_ptr));
			while ((sqlrow=mysql_fetch_row(res_ptr)))  {
/*				fprintf(stderr,"LEVVLST:Fetched data....}");	*/
				display_row();
				i++;
			}
			fprintf(stdout,"\n");
