...
/***************************************************************************
	...
	Kommando: ./LEVVDSP levvilkor [databas]

	Function: H?mta data f?r angivet leveransvillkor fr?n tabellen LEVVILLKOR

	OUTPUT: data, errornb och error (text)

 ***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/LEVVDSP.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/*  fprintf(stdout,"BARDSPmain:Connection success\n"); */
  	...
  	if (res){
		fprintf(stderr,"Error: LEVVDSP SELECT error: %s\n",mysql_error(&my_connection));
  	}
  	else{
...
/*			fprintf(stderr,"Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr)); */
			...
			if (mysql_errno(&my_connection)){
				fprintf(stderr,"Error: LEVVDSP Retriev error:  %s\n", mysql_error(&my_connection));
			}
		}
