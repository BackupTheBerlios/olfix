...
/*
	...
	Function: Visa data från tabell TEXTREG

	OUTPUT: TEXTNR och TXT eller errornb och error (text)

*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/TXTDSP.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
