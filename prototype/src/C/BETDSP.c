...
/***************************************************************************
	...
	Kommando: ./BETDSP betvilkor [databas]

	Function: Hämta data för angivet betalningsvillkor från BETVILKOR

	OUTPUT: data, errornb och error (text)

 ***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/BETDSP.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
//  MYSQL my_connection;
  ...
  char temp1[]="SELECT * FROM BETVILKOR WHERE BETVILKOR = \"";
  char temp2[]="\"";
  char temp5[200]="";
  char betvilkor[8];
/*  fprintf(stderr,"argc=%d \n",argc); */
  if (argc <2){
  	fprintf(stderr,"Error: Betalningsvillkor saknas.\n");
	exit(-1);
  }
/* ================================================================================ */
