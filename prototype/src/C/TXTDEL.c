...
/*
	...
	Kommando: ./TXTDEL textnr

	Function: Radera post från tabell TEXTREG

	OUTPUT: errornb och error (text)

*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/TXTDEL.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/* DELETE FROM TEXTREG WHERE TEXTNR = "  */
  strncat(temp5,textnr,strlen(textnr));/* 001 */
/* DELETE FROM TEXTREG WHERE TEXTNR = "001  	*/
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
/* DELETE FROM TEXTREG WHERE TEXTNR = "001" 	*/
/*  fprintf(stderr,"TXTDEL: temp5 = %s\n",temp5) */
  mysql_init(&my_connection);

  if (mysql_real_connect(&my_connection, "localhost",  "olfix", "olfix", databas, 0, NULL, 0)){
/*  fprintf(stdout,"TXTDEL:Connection success\n");	*/
