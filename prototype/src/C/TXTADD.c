...
/*	INPUT: 2 st arg. TEXTNR och TXT (fälten i tabellen TEXTREG)
...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/C/Attic/TXTADD.c,v 1.1 2004/05/03 04:42:57 janpihlgren Exp $ " ;
...
/*  int i;	*/
  ...
  char temp1[]="INSERT INTO TEXTREG(TEXTNR,TXT) VALUES (\"";
  char temp2[]="\"";
  char temp3[]=",";
  char temp4[]=")";
  char temp5[200]="";
...
/* INSERT INTO TEXTREG(TEXTNR,TXT) VALUES ("  */
  strncat(temp5,textnr,strlen(textnr));/* 001 */
/* INSERT INTO TEXTREG(TEXTNR,TXT) VALUES VALUES ("001  */
