/***************************************************************************
                          OFFLST.c  -  description
                             -------------------
			     Lista offerter med begränsad information
    Version		 : 0.4.3
...
/*
	...
	Function: Lista offerter ur tabellen OFFERTREG

	OUTPUT: OFFERTNR ORDERNR KUNDNR LEVDATUM ORDERSTATUS ORDERTOTAL
	samt errornb och error (text)

***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/OFFLST.c,v 1.1 2006/04/27 18:09:44 janpihlgren Exp $ " ;
