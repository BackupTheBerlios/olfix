...
int main( int argc, char* argv[] )
{
  ...
  frmChgBetalvillkor* mywidget = new frmChgBetalvillkor();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - CHGBETVW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n CHGBETVW kommer inte att fungera!\n");
