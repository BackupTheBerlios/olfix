...
*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/TRNSADD.c,v 1.4 2007/02/19 06:01:13 janpihlgren Exp $ " ;
...
/* ================================================================================ */
  ...
  strncpy(trnstxt,argv[2],sizeof(trnstxt));		/* 2005-02-24	*/
...
/* INSERT INTO TRANSID(TRNSID,TRNSTXT) VALUES (TRNSID,TRNSTXT) VALUES ("VERADD  */
  ...
  strncat(temp5,temp2,strlen(temp2)); /*  "     */
/* INSERT INTO TRANSID(TRNSID,TRNSTXT) VALUES (TRNSID,TRNSTXT) VALUES ("VERADD","  */
  strncat(temp5,trnstxt,strlen(trnstxt));/* förklarande text  */
