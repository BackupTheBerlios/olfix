...
/*
	INPUT: 3 st arg. BETVILKOR, DAGAR och BESKRIVNING (fälten i tabellen BETVILKOR)

	Kommando: ./BETCHG 001 10 "10 dagar netto"

	Function: Ändra record i tabell BETVILKOR

	OUTPUT: errornb och error (text)

*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/BETCHG.c,v 1.3 2007/02/13 05:44:15 janpihlgren Exp $ " ;
