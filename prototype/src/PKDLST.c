...
/*
	...
	Function: Lista data ur tabellen PRODUKTGRUPP,  PRODKLASS, BESKRIVNING
...
***************************************************************************/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/PKDLST.c,v 1.1 2004/12/01 05:06:23 janpihlgren Exp $ " ;
...
/* fprintf(stderr,"PKDLST argc = %d\n",argc);			*/
/*  for (i=0;i< argc;i++){
  	fprintf(stderr,"PKDLST argv%d = %s\n",i,argv[i]);
    }
*/
/* ================================================================================ */
...
/*  	fprintf(stdout,"PKDLST_Connection success\n");	*/
  	res = mysql_query(&my_connection,temp5);
/*  	fprintf(stderr,"PKDLST hit res=%d\n",res);	*/
  	if (res){
/*  		fprintf(stderr,"PKDLST ERROR\n");	*/
		fprintf(stderr,"Error: PKDLST SELECT errno: %d\n",mysql_errno(&my_connection));
        }else{
		res_ptr=mysql_store_result(&my_connection);
		if (res_ptr){
			i=1;
/*			fprintf(stdout,"PKDLST:Retrieved %lu rows\n",(unsigned long)mysql_num_rows(res_ptr));	*/
			fprintf(stdout,"OK: NR_%lu_:",(unsigned long)mysql_num_rows(res_ptr));
			while ((sqlrow=mysql_fetch_row(res_ptr)))  {
/*				fprintf(stderr,"PKDLST:Fetched data....}");	*/
				display_row();
				i++;
			}
			fprintf(stdout,"\n");
	...
	mysql_free_result(res_ptr);
    	...
    	if (mysql_errno(&my_connection))   {
    		fprintf(stderr,"Error: PKDLST Connection error %d:  %s\n",
