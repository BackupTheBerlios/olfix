...
int main( int argc, char* argv[] )
{
  ...
  frmAddLagerplats* mywidget = new frmAddLagerplats();
  mywidget->lineEditLagerplats->setText(QString(argv[1]));
  mywidget->lineEditArtikelNr->setText(QString(argv[2]));
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - ADDLPLW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n ADDLPL kommer inte att fungera!\n");
