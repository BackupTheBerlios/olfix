...
#include <qfont.h>
#include "frmdspartikelekonomidata.h"
...
int main( int argc, char* argv[] )
{
  ...
  frmDspArtikelEkonomidata* mywidget = new frmDspArtikelEkonomidata();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - DSPAREW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n DSPAREW kommer inte att fungera!\n");
