...
int main( int argc, char* argv[] )
{
  ...
  frmChangeLagerstelle* mywidget = new frmChangeLagerstelle();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - CHGLSW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n CHGLSW kommer inte att fungera!\n");
