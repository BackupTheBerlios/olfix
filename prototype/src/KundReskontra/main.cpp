...
int main( int argc, char* argv[] )
{
  ...
  frmKundReskontra* mywidget = new frmKundReskontra();
...
// Läs in config filen här
   ...
   if ( file.open( IO_ReadOnly ) ) {
	...
	QMessageBox::warning( mywidget, "OLFIX - KURESKW",
 	"Kan inte hitta filen $HOME/.olfixrc.\n KUFAKTW kommer inte att fungera!\n");
	qWarning( "Cannot find the $HOME/.olfixrc file" );
    }
   QDir::setCurrent ( bibl );
//   fprintf(stderr,"main.cpp\n");
