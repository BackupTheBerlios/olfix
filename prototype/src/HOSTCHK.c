/***************************************************************************
                          HOSTCHK.c  -  description
                             ------------------
    Version		 			: 0.1x
    begin               : Ons 28 nov 2007
    modified		 		:
...
/*
	...
	INPUT:
	Kontrolera vilken host/server som databasen ligger på

	OUTPUT: IP-address till databasen enligt .olfixrc 
	errornb och error (text)

*/
 /*@unused@*/ static char RCS_id[] =
    "@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/olfix/Repository/prototype/src/HOSTCHK.c,v 1.1 2007/12/05 04:45:19 janpihlgren Exp $ " ;
